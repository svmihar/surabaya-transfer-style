...
$NEURAL_STYLE \
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out1.png \
  -style_scale $STYLE_SCALE \
  -print_iter 1 \
  -style_weight $STYLE_WEIGHT \
  -image_size 512 \
  -num_iterations 500 \
  -output_image p_on_p/out2.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn -cudnn_autotune
...
$NEURAL_STYLE \
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out2.png \
  -style_scale $STYLE_SCALE \
  -print_iter 1 \
  -style_weight $STYLE_WEIGHT \
  -image_size 1024 \
  -num_iterations 200 \
  -output_image p_on_p/out3.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn -cudnn_autotune
...
$NEURAL_STYLE \
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out3.png \
  -style_scale $STYLE_SCALE \
  -print_iter 1 \
  -style_weight $STYLE_WEIGHT2 \
  -image_size 1024 \
  -num_iterations 200 \
  -output_image p_on_p/out4.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn
...
$NEURAL_STYLE \
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out4.png \
  -style_scale $STYLE_SCALE \
  -print_iter 10 \
  -style_weight $STYLE_WEIGHT2 \
  -image_size 1024 \
  -num_iterations 2000 \
  -output_image p_on_p/out5.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn
...
$NEURAL_STYLE \
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out5.png \
  -style_scale $STYLE_SCALE \
  -print_iter 10 \
  -style_weight $STYLE_WEIGHT2 \
  -image_size 1024 \
  -num_iterations 2000 \
  -output_image p_on_p/out6.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn
  ...
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out6.png \
  -style_scale $STYLE_SCALE \
  -print_iter 10 \
  -style_weight $STYLE_WEIGHT2 \
  -image_size 1024 \
  -num_iterations 2000 \
  -output_image p_on_p/out7.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn
  ...
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out7.png \
  -style_scale $STYLE_SCALE \
  -print_iter 10 \
  -style_weight $STYLE_WEIGHT2 \
  -image_size 1024 \
  -num_iterations 2000 \
  -output_image p_on_p/out8.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn
  ...
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out8.png \
  -style_scale $STYLE_SCALE \
  -print_iter 10 \
  -style_weight $STYLE_WEIGHT2 \
  -image_size 1024 \
  -num_iterations 2000 \
  -output_image p_on_p/out9.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn
  ...
  -content_image $CONTENT_IMAGE \
  -style_image $STYLE_IMAGE \
  -init image -init_image p_on_p/out9.png \
  -style_scale $STYLE_SCALE \
  -print_iter 10 \
  -style_weight $STYLE_WEIGHT2 \
  -image_size 1024 \
  -num_iterations 2000 \
  -output_image p_on_p/out10.png \
  -tv_weight 0 \
  -gpu $GPU \
  -backend cudnn